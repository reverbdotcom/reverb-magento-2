...
class Orderurl implements \Magento\Framework\Option\ArrayInterface
{
    ...
    public function shouldOnlySyncPaidOrders()
    {
        ...
        {
            $order_sync_source_url_configuration_setting = $this->scopeConfig->getValue(self::SOURCE_ORDER_URL_CONFIG, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    {
        return array(
            array('value' => self::ALL_ORDERS_URL, 'label' => __(self::ALL_ORDERS_LABEL)),
            array('value' => self::ORDERS_AWAITING_SHIPMENT_URL, 'label' => __(self::ORDERS_AWAITING_SHIPMENT_LABEL)),
        );
    }
    ...
    {
        return array(
            self::ALL_ORDERS_URL => __(self::ALL_ORDERS_LABEL),
            self::ORDERS_AWAITING_SHIPMENT_URL => __(self::ORDERS_AWAITING_SHIPMENT_LABEL),
        );
    }
}
